        ...
        <div class="px-8 pb-8 overflow-y-auto flex-1">
          ...
          <div v-if="popupTitle === '溫室環控｜光積值灌溉'">
            ...
            <div>
              ...
              <div class="bg-gray-200 p-6 rounded-lg">
                <div class="text-center mb-6">
                  <img src="/assets/場域規劃/積木/光積值.png" alt="桃改場專家積木" class="w-full max-w-lg mx-auto shadow-sm cursor-pointer hover:opacity-80 transition-opacity" @error="handleImageError" @click="openImageModal('/assets/場域規劃/積木/光積值.png', '桃改場專家積木')"/>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div class="bg-white p-4 rounded-md shadow-sm">
          ...
          <div v-if="popupTitle === '溫室環控｜注肥'">
            ...
            <div>
              ...
              <div class="bg-gray-200 p-6 rounded-lg">
                <div class="text-center mb-6">
                  <img src="/assets/場域規劃/積木/注肥.png" alt="桃改場專家積木" class="w-full max-w-lg mx-auto shadow-sm cursor-pointer hover:opacity-80 transition-opacity" @error="handleImageError" @click="openImageModal('/assets/場域規劃/積木/注肥.png', '桃改場專家積木')"/>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div class="bg-white p-4 rounded-md shadow-sm">
